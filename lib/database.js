...
exports.getUrl = function getUrl() {
  ...
  return AUTH0_DOMAIN + "/authorize?audience=" + AUDIENCE_URI + "&scope=openid%20profile%20offline_access&response_type=code&client_id=" + CLIENT_ID + "&code_challenge=" + challenge + "&code_challenge_method=S256&redirect_uri=" + CODE_REDIRECT_URI;
}
